class Adamax(optimizer_v2.OptimizerV2):
  ...
  """
    ...
    def _resource_apply_dense(self, grad, var, apply_state=None):
        ...
        return gen_training_ops.ResourceApplyAdaMax(var=var.handle, m=m.handle, v=v.handle, beta1_power=coefficients['beta_1_power'], lr=coefficients['lr_t'], beta1=coefficients['beta_1_t'], beta2=coefficients['beta_2_t'], epsilon=coefficients['epsilon'], grad=grad, use_locking=self._use_locking)
